        ...
        try {
            if (/Android/.test(navigator.userAgent)) {
                ...
                if (typeof MyApp !== "undefined") {
                    window.MyApp[match ? "onSuccess" : "onFailure"](message, JSON.stringify({}));
                } else {
                ...
                if (typeof webkit !== "undefined") {
                    window.webkit.messageHandlers.MyApp.postMessage({ event: match ? "onSuccess" : "onFailure", data: JSON.stringify({}) });
                } else {
